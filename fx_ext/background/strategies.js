...
let ExtIstrStrategies = [{
    ...
    name: '跌停翘板',
    desc: '盘中: 跌停撬板, 优先选封单金额大的,从前高下来换手小, 跌幅大. 早上9:33之后开始监控防止有的票早盘撬板又封死, 下午2:30之后取消。' +
        '竞价若昨日跌停数>5家,今日竞价无跌停,则选昨日跌停中今日开盘最低的几只.'
}, {
    key: 'istrategy_idxtrack',
    name: '指数跟踪策略',
    desc: '跟踪指数的买入策略, 盘中指数如果出现主力净流入1分钟流入>1亿或者10分钟累积净流入>5亿则符合买入条件,' +
        '满足买入条件无仓位或与上次买入有一定跌幅则买入.'
}];
